...
DATASET_ROOT = "/content/drive/MyDrive/Button click dataset"   
...
for wav_path, label_path in tqdm(pairs, desc="Processing Audio Sequences"):
    ...
    for (start, end, class_idx) in segments:
        ...
        # Apply Augmentation targeting the underperforming class ---
...
# Apply temporal sequence padding and truncating ---
