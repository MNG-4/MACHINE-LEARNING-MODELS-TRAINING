...
Original file is located at
    https://colab.research.google.com/drive/1VmN8oWOZRxnHo26uzcpUMeY86NJ575qd
"""
...
def normalize_diacritics(text: str) -> str:
    ...
    # Step 3 – (optional) warn about unexpected combining characters
    # Uncomment the block below to surface any combining marks that are
    # present in the data but not covered by your map:
    #
    # for ch in text:
    #     if unicodedata.category(ch) == "Mn":   # "Mn" = non-spacing mark
    #         print(f"[WARN] Unexpected combining char U+{ord(ch):04X} "
    #               f"({unicodedata.name(ch, '?')}) in: {text!r}")
